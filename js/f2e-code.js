...
function load_code_data(o) {
    ...
    for (var i = 0; i < o.list.length; i++) {
        _url = "http://v.t.sina.com.cn/share/share.php?appkey=941104388&title="+encodeURIComponent(o.list[i].title)+" %23窦超阳F2E%23&url="+encodeURIComponent("http://www.douchaoyang.com/");
